...
static MotorDriver motors[NUM_MOTORS] = {
    MotorDriver(MOTOR_PWM_PIN[0], MOTOR_DIR_PIN[0], LEDC_CHANNEL_0, MOTOR_OUTPUT_INVERT),
    MotorDriver(MOTOR_PWM_PIN[1], MOTOR_DIR_PIN[1], LEDC_CHANNEL_1, MOTOR_OUTPUT_INVERT)
#if NUM_MOTORS > 2
    , MotorDriver(MOTOR_PWM_PIN[2], MOTOR_DIR_PIN[2], LEDC_CHANNEL_2, MOTOR_OUTPUT_INVERT)
#endif
#if NUM_MOTORS > 3
    , MotorDriver(MOTOR_PWM_PIN[3], MOTOR_DIR_PIN[3], LEDC_CHANNEL_3, MOTOR_OUTPUT_INVERT)
#endif
};
